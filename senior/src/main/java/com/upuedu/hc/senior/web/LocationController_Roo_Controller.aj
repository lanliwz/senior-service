...
import com.upuedu.hc.senior.web.LocationController;
...
privileged aspect LocationController_Roo_Controller {
    ...
    public String LocationController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String LocationController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Location.findLocation(id));
        return "locations/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String LocationController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void LocationController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("location_recordtime_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
